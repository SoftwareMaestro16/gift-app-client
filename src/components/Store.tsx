...
import { storeIconActive } from '../assets/menuImages/menuImgaesActive';
import { giftIcon, leaderboardIcon, profileIcon } from '../assets/menuImages/menuImagesNone';
import { mainStoreIcon } from '../assets/storeImages/mainStoreIcon';
import { cakeIcon, greenIcon, blueIcon, redIcon } from '../assets/giftBackgrounds/giftBackgroundsStore';
import { tetherIcon, ethereumIcon, tonIcon } from '../assets/crypto/cryptoAssets';
                    ...
                    <div className="gifts-grid">
                        <div className="gift-item">
                            <div className="gift-background gift-cake">
                                ...
                                <button className="price-button">
                                    <span className="icon-tether">{tetherIcon}</span>10 USDT
                                </button>
                            </div>
                        </div>
                        ...
                        <div className="gift-item">
                            <div className="gift-background gift-green">
                                ...
                                <h4>Green Star</h4>
                                <button className="price-button">
                                    <span className="icon">{tonIcon}</span>5 TON
                                </button>
                            </div>ы
                        </div>
                        ...
                        <div className="gift-item">
                            <div className="gift-background gift-blue">
                                ...
                                <h4>Blue Star</h4>
                                <button className="price-button">
                                    <span className="icon">{tonIcon}</span>10 TON
                                </button>
                            </div>
                        </div>
                        ...
                        <div className="gift-item">
                            <div className="gift-background gift-red">
                                ...
                                <h4>Red Star</h4>
                                <button className="price-button">
                                    <span className="icon">{ethereumIcon}</span>0.01 ETH
                                </button>
                            </div>
                        </div>
                    </div>
